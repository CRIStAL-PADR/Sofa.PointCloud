...
class PointCloudOctreeRenderer : public sofa::core::visual::VisualModel {
private:
    template<class T>
    using Link = core::objectmodel::SingleLink<PointCloudOctreeRenderer, T, core::objectmodel::BaseLink::FLAG_STOREPATH>;

public:
    SOFA_CLASS(PointCloudOctreeRenderer, BaseObject);

    PointCloudOctreeRenderer();
    ~PointCloudOctreeRenderer() override;
